...
<head>
    ...
    <link href="{{ url('assets/bower_components/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">-->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"> AdvWeb</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-calendar"></i> Agenda</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-gavel"></i> Pastas / Processos</a> 
                           <!-- <ul class="nav nav-second-level"> <span class="fa arrow"></span></a>
                                <li>
                                    <a href="flot.html">T</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="tables.html"><i class="fa fa-clock-o"></i> Ficha Tempo</a>
                        </li>
                        <li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Debite</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-file"></i> GED</a> 
                        </li>
